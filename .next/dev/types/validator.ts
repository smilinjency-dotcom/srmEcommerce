...
// Validate ../../../app/api/order-status/[id]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/order-status/[id]">> = Specific
  const handler = {} as typeof import("../../../app/api/order-status/[id]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../../app/api/verify-razorpay-payment/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/verify-razorpay-payment">> = Specific
  const handler = {} as typeof import("../../../app/api/verify-razorpay-payment/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
